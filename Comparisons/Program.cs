    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
             ...
             * &    и
             * !    не
             * операция && сначала вычисляет значение только одного выражения из двух, 
             * и только если первое равно true, происходит дальнейшее вычисление, а & вычисляет оба в любом случае
            */
